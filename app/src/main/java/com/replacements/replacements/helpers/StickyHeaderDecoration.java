...
public class StickyHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    private ReplacementsFragment.ReplacementsAdapter mAdapter;
     ...
     */
    public StickyHeaderDecoration(ReplacementsFragment.ReplacementsAdapter adapter) {
        this(adapter, false);
    }
     ...
     *         the sticky header adapter to use
     */
    public StickyHeaderDecoration(ReplacementsFragment.ReplacementsAdapter adapter, boolean renderInline) {
        mAdapter = adapter;
    ...
    private RecyclerView.ViewHolder getHeader(RecyclerView parent, int position) {
        ...
        if (mHeaderCache.containsKey(key)) {
            ...
            final ReplacementsFragment.ReplacementsAdapter.HeaderHolder holder = mAdapter.onCreateHeaderViewHolder(parent);
